...
The objectives of this work were to analyse the data recovered from the campaign mission held during February 2019, in which there were more sensors installed especially in the bottom and the lower region of the meteorological station. This tackled the limitations found in the previous works mentioned above, where the lack of instruments in the lower level of the mast didn't allow to measure the katabatic wind maximum. From this data, we identified the katabatic wind episodes and performed an analysis of its turbulent characteristics.
